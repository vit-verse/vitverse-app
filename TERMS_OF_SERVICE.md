...
VIT Verse is an unofficial, student-developed mobile application for VIT Chennai students. By downloading, installing, or using this app, you acknowledge and agree to be bound by these terms.
...
You agree to:
- Use only your own legitimate VTOP credentials
- Not share, sell, or distribute your account access
- Not use the app for unauthorized access, data scraping, or malicious purposes
...
- **Data Accuracy**: Information displayed is sourced from VTOP. We do not guarantee correctness, completeness, or timeliness
...
This app is open-source software licensed under the MIT License. Source code is available at [github.com/vit-verse](https://github.com/vit-verse).

VIT, VIT Chennai, VTOP, and related trademarks belong to VIT University and are used for identification purposes only. All other trademarks and brand names are property of their respective owners.
...
You may stop using the app at any time by uninstalling it. We reserve the right to discontinue the app or any features without notice.

---

## 9. Modifications to Terms

We may update these Terms of Service at any time. Continued use of the app after changes constitutes acceptance of the updated terms. It is your responsibility to review these terms periodically.
...
You agree to indemnify and hold harmless the app developers, contributors, and associated parties from any claims, damages, liabilities, or expenses arising from your use of the app or violation of these terms.
